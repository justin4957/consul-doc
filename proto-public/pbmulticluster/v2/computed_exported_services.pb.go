...
/*
# Module: proto-public/pbmulticluster/v2/computed_exported_services.pb.go
Computed Exported Services.Pb module for internal layer
...
## Exports
ComputedExportedService, ComputedExportedServiceConsumer, ComputedExportedServices, File

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto-public/pbmulticluster/v2/computed_exported_services.pb.go> a code:Module ;
    code:name "proto-public/pbmulticluster/v2/computed_exported_services.pb.go" ;
    code:description "Computed Exported Services.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :ComputedExportedService, :ComputedExportedServiceConsumer, :ComputedExportedServices, :File ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
