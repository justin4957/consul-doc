...
/*
# Module: proto-public/pbmulticluster/v2/computed_exported_services.pb.binary.go
Computed Exported Services.Pb.Binary module for internal layer
...
<proto-public/pbmulticluster/v2/computed_exported_services.pb.binary.go> a code:Module ;
    code:name "proto-public/pbmulticluster/v2/computed_exported_services.pb.binary.go" ;
    code:description "Computed Exported Services.Pb.Binary module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
