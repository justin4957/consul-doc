...
/*
# Module: proto-public/pbdataplane/dataplane_deepcopy.gen.go
Dataplane Deepcopy.Gen module for internal layer
...
<proto-public/pbdataplane/dataplane_deepcopy.gen.go> a code:Module ;
    code:name "proto-public/pbdataplane/dataplane_deepcopy.gen.go" ;
    code:description "Dataplane Deepcopy.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
