...
/*
# Module: proto-public/pbdataplane/dataplane_cloning_grpc.pb.go
Dataplane Cloning Grpc.Pb module for internal layer

## Tags
api, communication, grpc, internal, networking

## Exports
CloningDataplaneServiceClient, IsCloningDataplaneServiceClient, NewCloningDataplaneServiceClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto-public/pbdataplane/dataplane_cloning_grpc.pb.go> a code:Module ;
    code:name "proto-public/pbdataplane/dataplane_cloning_grpc.pb.go" ;
    code:description "Dataplane Cloning Grpc.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :CloningDataplaneServiceClient, :IsCloningDataplaneServiceClient, :NewCloningDataplaneServiceClient ;
