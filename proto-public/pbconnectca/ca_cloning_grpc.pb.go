...
/*
# Module: proto-public/pbconnectca/ca_cloning_grpc.pb.go
Ca Cloning Grpc.Pb module for internal layer

## Tags
api, communication, grpc, internal, mtls, networking, service-mesh

## Exports
CloningConnectCAServiceClient, IsCloningConnectCAServiceClient, NewCloningConnectCAServiceClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto-public/pbconnectca/ca_cloning_grpc.pb.go> a code:Module ;
    code:name "proto-public/pbconnectca/ca_cloning_grpc.pb.go" ;
    code:description "Ca Cloning Grpc.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :CloningConnectCAServiceClient, :IsCloningConnectCAServiceClient, :NewCloningConnectCAServiceClient ;
