...
/*
# Module: proto-public/pbserverdiscovery/serverdiscovery_cloning_grpc.pb.go
Serverdiscovery Cloning Grpc.Pb module for internal layer

## Tags
api, communication, discovery, dns, grpc, internal, networking

## Exports
CloningServerDiscoveryServiceClient, IsCloningServerDiscoveryServiceClient, NewCloningServerDiscoveryServiceClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto-public/pbserverdiscovery/serverdiscovery_cloning_grpc.pb.go> a code:Module ;
    code:name "proto-public/pbserverdiscovery/serverdiscovery_cloning_grpc.pb.go" ;
    code:description "Serverdiscovery Cloning Grpc.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :CloningServerDiscoveryServiceClient, :IsCloningServerDiscoveryServiceClient, :NewCloningServerDiscoveryServiceClient ;
