...
/*
# Module: proto-public/pbresource/resource_cloning_grpc.pb.go
Resource Cloning Grpc.Pb module for internal layer

## Tags
api, communication, grpc, internal, networking

## Exports
CloningResourceServiceClient, IsCloningResourceServiceClient, NewCloningResourceServiceClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto-public/pbresource/resource_cloning_grpc.pb.go> a code:Module ;
    code:name "proto-public/pbresource/resource_cloning_grpc.pb.go" ;
    code:description "Resource Cloning Grpc.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :CloningResourceServiceClient, :IsCloningResourceServiceClient, :NewCloningResourceServiceClient ;
