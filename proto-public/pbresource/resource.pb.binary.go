...
/*
# Module: proto-public/pbresource/resource.pb.binary.go
Resource.Pb.Binary module for internal layer
...
<proto-public/pbresource/resource.pb.binary.go> a code:Module ;
    code:name "proto-public/pbresource/resource.pb.binary.go" ;
    code:description "Resource.Pb.Binary module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
