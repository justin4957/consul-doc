...
/*
# Module: proto-public/pbresource/resource_json.gen.go
Resource Json.Gen module for internal layer
...
<proto-public/pbresource/resource_json.gen.go> a code:Module ;
    code:name "proto-public/pbresource/resource_json.gen.go" ;
    code:description "Resource Json.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
