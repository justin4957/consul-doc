...
/*
# Module: proto-public/pbacl/acl_deepcopy.gen.go
Acl Deepcopy.Gen module for internal layer
...
<proto-public/pbacl/acl_deepcopy.gen.go> a code:Module ;
    code:name "proto-public/pbacl/acl_deepcopy.gen.go" ;
    code:description "Acl Deepcopy.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
