...
/*
# Module: proto-public/pbacl/acl_cloning_grpc.pb.go
Acl Cloning Grpc.Pb module for internal layer

## Tags
access-control, api, authorization, communication, grpc, internal, networking, security

## Exports
CloningACLServiceClient, IsCloningACLServiceClient, NewCloningACLServiceClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto-public/pbacl/acl_cloning_grpc.pb.go> a code:Module ;
    code:name "proto-public/pbacl/acl_cloning_grpc.pb.go" ;
    code:description "Acl Cloning Grpc.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :CloningACLServiceClient, :IsCloningACLServiceClient, :NewCloningACLServiceClient ;
