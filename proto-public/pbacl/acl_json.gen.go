...
/*
# Module: proto-public/pbacl/acl_json.gen.go
Acl Json.Gen module for internal layer
...
<proto-public/pbacl/acl_json.gen.go> a code:Module ;
    code:name "proto-public/pbacl/acl_json.gen.go" ;
    code:description "Acl Json.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
