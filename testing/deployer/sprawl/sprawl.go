...
/*
# Module: testing/deployer/sprawl/sprawl.go
Sprawl module for internal layer
...
<testing/deployer/sprawl/sprawl.go> a code:Module ;
    code:name "testing/deployer/sprawl/sprawl.go" ;
    code:description "Sprawl module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
        code:name "api" ;
