...
/*
# Module: testing/deployer/sprawl/internal/tfgen/nodes.go
Nodes module for internal layer
...
<testing/deployer/sprawl/internal/tfgen/nodes.go> a code:Module ;
    code:name "testing/deployer/sprawl/internal/tfgen/nodes.go" ;
    code:description "Nodes module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
