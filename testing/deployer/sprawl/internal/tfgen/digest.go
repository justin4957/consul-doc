...
/*
# Module: testing/deployer/sprawl/internal/tfgen/digest.go
Digest module for internal layer
...
<testing/deployer/sprawl/internal/tfgen/digest.go> a code:Module ;
    code:name "testing/deployer/sprawl/internal/tfgen/digest.go" ;
    code:description "Digest module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
