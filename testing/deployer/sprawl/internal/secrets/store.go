...
/*
# Module: testing/deployer/sprawl/internal/secrets/store.go
...
<testing/deployer/sprawl/internal/secrets/store.go> a code:Module ;
    code:name "testing/deployer/sprawl/internal/secrets/store.go" ;
