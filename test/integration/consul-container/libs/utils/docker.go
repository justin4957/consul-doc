...
/*
# Module: test/integration/consul-container/libs/utils/docker.go
...
## Exports
DockerExec, DockerImageVersion

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<test/integration/consul-container/libs/utils/docker.go> a code:Module ;
    code:name "test/integration/consul-container/libs/utils/docker.go" ;
    code:description "Docker module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :DockerExec, :DockerImageVersion ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package utils
