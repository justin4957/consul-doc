...
/*
# Module: test/integration/consul-container/libs/utils/retry.go
Retry module for internal layer
...
<test/integration/consul-container/libs/utils/retry.go> a code:Module ;
    code:name "test/integration/consul-container/libs/utils/retry.go" ;
    code:description "Retry module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :Waiter ;
    code:tags "internal" .
