...
/*
# Module: test/integration/consul-container/libs/cluster/network.go
Network module for internal layer
...
<test/integration/consul-container/libs/cluster/network.go> a code:Module ;
    code:name "test/integration/consul-container/libs/cluster/network.go" ;
    code:description "Network module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
