...
/*
# Module: test/integration/consul-container/libs/topology/peering_topology.go
Peering Topology module for internal layer
...
## Exports
BasicPeeringTwoClustersSetup, BuiltCluster, ClusterConfig, NewCluster, NewClusterWithConfig, PeeringClusterSize, TestLogConsumer

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<test/integration/consul-container/libs/topology/peering_topology.go> a code:Module ;
    code:name "test/integration/consul-container/libs/topology/peering_topology.go" ;
    code:description "Peering Topology module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
        code:name "api" ;
    ...
    code:exports :BasicPeeringTwoClustersSetup, :BuiltCluster, :ClusterConfig, :NewCluster, :NewClusterWithConfig, :PeeringClusterSize, :TestLogConsumer ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package topology
