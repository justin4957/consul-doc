...
/*
# Module: proto/private/pbconfigentry/config_entry.go
Config Entry module for internal layer
...
## Exports
ConfigEntryFromStructs, ConfigEntryToStructs, EnvoyExtensionsFromStructs, EnvoyExtensionsToStructs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbconfigentry/config_entry.go> a code:Module ;
    code:name "proto/private/pbconfigentry/config_entry.go" ;
    code:description "Config Entry module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :ConfigEntryFromStructs, :ConfigEntryToStructs, :EnvoyExtensionsFromStructs, :EnvoyExtensionsToStructs ;
