...
/*
# Module: proto/private/pbconfigentry/config_entry.pb.binary.go
Config Entry.Pb.Binary module for internal layer
...
<proto/private/pbconfigentry/config_entry.pb.binary.go> a code:Module ;
    code:name "proto/private/pbconfigentry/config_entry.pb.binary.go" ;
    code:description "Config Entry.Pb.Binary module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
