...
/*
# Module: proto/private/pbconfigentry/config_entry.gen.go
Config Entry.Gen module for internal layer
...
## Exports
APIGatewayFromStructs, APIGatewayListenerFromStructs, APIGatewayListenerToStructs, APIGatewayPolicyFromStructs, APIGatewayPolicyToStructs, APIGatewayTLSConfigurationFromStructs, APIGatewayTLSConfigurationToStructs, APIGatewayToStructs, BoundAPIGatewayFromStructs, BoundAPIGatewayListenerFromStructs, BoundAPIGatewayListenerToStructs, BoundAPIGatewayToStructs, ConditionFromStructs, ConditionToStructs, CookieConfigFromStructs, CookieConfigToStructs, DestinationConfigFromStructs, DestinationConfigToStructs, ExportedServicesConsumerFromStructs, ExportedServicesConsumerToStructs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbconfigentry/config_entry.gen.go> a code:Module ;
    code:name "proto/private/pbconfigentry/config_entry.gen.go" ;
    code:description "Config Entry.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :APIGatewayFromStructs, :APIGatewayListenerFromStructs, :APIGatewayListenerToStructs, :APIGatewayPolicyFromStructs, :APIGatewayPolicyToStructs, :APIGatewayTLSConfigurationFromStructs, :APIGatewayTLSConfigurationToStructs, :APIGatewayToStructs, :BoundAPIGatewayFromStructs, :BoundAPIGatewayListenerFromStructs, :BoundAPIGatewayListenerToStructs, :BoundAPIGatewayToStructs, :ConditionFromStructs, :ConditionToStructs, :CookieConfigFromStructs, :CookieConfigToStructs, :DestinationConfigFromStructs, :DestinationConfigToStructs, :ExportedServicesConsumerFromStructs, :ExportedServicesConsumerToStructs ;
