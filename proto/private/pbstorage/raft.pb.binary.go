...
/*
# Module: proto/private/pbstorage/raft.pb.binary.go
Raft.Pb.Binary module for internal layer
...
<proto/private/pbstorage/raft.pb.binary.go> a code:Module ;
    code:name "proto/private/pbstorage/raft.pb.binary.go" ;
    code:description "Raft.Pb.Binary module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
