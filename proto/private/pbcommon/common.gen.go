...
/*
# Module: proto/private/pbcommon/common.gen.go
Common.Gen module for internal layer
...
## Exports
EnvoyExtensionFromStructs, EnvoyExtensionToStructs, LocalityFromStructs, LocalityToStructs, QueryMetaFromStructs, QueryMetaToStructs, QueryOptionsFromStructs, QueryOptionsToStructs, RaftIndexFromStructs, RaftIndexToStructs, WriteRequestFromStructs, WriteRequestToStructs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbcommon/common.gen.go> a code:Module ;
    code:name "proto/private/pbcommon/common.gen.go" ;
    code:description "Common.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :EnvoyExtensionFromStructs, :EnvoyExtensionToStructs, :LocalityFromStructs, :LocalityToStructs, :QueryMetaFromStructs, :QueryMetaToStructs, :QueryOptionsFromStructs, :QueryOptionsToStructs, :RaftIndexFromStructs, :RaftIndexToStructs, :WriteRequestFromStructs, :WriteRequestToStructs ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package pbcommon
