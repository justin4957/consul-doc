...
/*
# Module: proto/private/pbservice/node.gen.go
Node.Gen module for internal layer
...
## Exports
NodeFromStructs, NodeServiceFromStructs, NodeServiceToStructs, NodeToStructs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbservice/node.gen.go> a code:Module ;
    code:name "proto/private/pbservice/node.gen.go" ;
    code:description "Node.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :NodeFromStructs, :NodeServiceFromStructs, :NodeServiceToStructs, :NodeToStructs ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package pbservice
