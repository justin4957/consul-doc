...
/*
# Module: proto/private/pbservice/service.gen.go
Service.Gen module for internal layer
...
## Exports
AccessLogsConfigFromStructs, AccessLogsConfigToStructs, ConnectProxyConfigFromStructs, ConnectProxyConfigToStructs, ExposeConfigFromStructs, ExposeConfigToStructs, ExposePathFromStructs, ExposePathToStructs, MeshGatewayConfigFromStructs, MeshGatewayConfigToStructs, PeeringServiceMetaFromStructs, PeeringServiceMetaToStructs, ServiceConnectFromStructs, ServiceConnectToStructs, ServiceDefinitionFromStructs, ServiceDefinitionToStructs, ServicePortFromStructs, ServicePortToStructs, TransparentProxyConfigFromStructs, TransparentProxyConfigToStructs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbservice/service.gen.go> a code:Module ;
    code:name "proto/private/pbservice/service.gen.go" ;
    code:description "Service.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :AccessLogsConfigFromStructs, :AccessLogsConfigToStructs, :ConnectProxyConfigFromStructs, :ConnectProxyConfigToStructs, :ExposeConfigFromStructs, :ExposeConfigToStructs, :ExposePathFromStructs, :ExposePathToStructs, :MeshGatewayConfigFromStructs, :MeshGatewayConfigToStructs, :PeeringServiceMetaFromStructs, :PeeringServiceMetaToStructs, :ServiceConnectFromStructs, :ServiceConnectToStructs, :ServiceDefinitionFromStructs, :ServiceDefinitionToStructs, :ServicePortFromStructs, :ServicePortToStructs, :TransparentProxyConfigFromStructs, :TransparentProxyConfigToStructs ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package pbservice
