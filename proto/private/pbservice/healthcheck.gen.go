...
/*
# Module: proto/private/pbservice/healthcheck.gen.go
Healthcheck.Gen module for internal layer
...
## Exports
CheckTypeFromStructs, CheckTypeToStructs, HealthCheckDefinitionFromStructs, HealthCheckDefinitionToStructs, HealthCheckFromStructs, HealthCheckToStructs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbservice/healthcheck.gen.go> a code:Module ;
    code:name "proto/private/pbservice/healthcheck.gen.go" ;
    code:description "Healthcheck.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :CheckTypeFromStructs, :CheckTypeToStructs, :HealthCheckDefinitionFromStructs, :HealthCheckDefinitionToStructs, :HealthCheckFromStructs, :HealthCheckToStructs ;
