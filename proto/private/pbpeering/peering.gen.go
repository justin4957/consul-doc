...
/*
# Module: proto/private/pbpeering/peering.gen.go
Peering.Gen module for internal layer
...
## Exports
EstablishRequestFromAPI, EstablishRequestToAPI, EstablishResponseFromAPI, EstablishResponseToAPI, GenerateTokenRequestFromAPI, GenerateTokenRequestToAPI, GenerateTokenResponseFromAPI, GenerateTokenResponseToAPI, PeeringFromAPI, PeeringToAPI, RemoteInfoFromAPI, RemoteInfoToAPI

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbpeering/peering.gen.go> a code:Module ;
    code:name "proto/private/pbpeering/peering.gen.go" ;
    code:description "Peering.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
        code:name "api" ;
    ...
    code:exports :EstablishRequestFromAPI, :EstablishRequestToAPI, :EstablishResponseFromAPI, :EstablishResponseToAPI, :GenerateTokenRequestFromAPI, :GenerateTokenRequestToAPI, :GenerateTokenResponseFromAPI, :GenerateTokenResponseToAPI, :PeeringFromAPI, :PeeringToAPI, :RemoteInfoFromAPI, :RemoteInfoToAPI ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package pbpeering
