...
/*
# Module: proto/private/pbpeering/peering.pb.binary.go
Peering.Pb.Binary module for internal layer
...
<proto/private/pbpeering/peering.pb.binary.go> a code:Module ;
    code:name "proto/private/pbpeering/peering.pb.binary.go" ;
    code:description "Peering.Pb.Binary module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
