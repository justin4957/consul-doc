...
/*
# Module: proto/private/pbconnect/connect.gen.go
Connect.Gen module for internal layer
...
## Exports
CARootFromStructsCARoot, CARootToStructsCARoot, CARootsFromStructsIndexedCARoots, CARootsToStructsIndexedCARoots, IssuedCertFromStructsIssuedCert, IssuedCertToStructsIssuedCert

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<proto/private/pbconnect/connect.gen.go> a code:Module ;
    code:name "proto/private/pbconnect/connect.gen.go" ;
    code:description "Connect.Gen module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :CARootFromStructsCARoot, :CARootToStructsCARoot, :CARootsFromStructsIndexedCARoots, :CARootsToStructsIndexedCARoots, :IssuedCertFromStructsIssuedCert, :IssuedCertToStructsIssuedCert ;
