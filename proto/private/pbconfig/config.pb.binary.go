...
/*
# Module: proto/private/pbconfig/config.pb.binary.go
Config.Pb.Binary module for internal layer
...
<proto/private/pbconfig/config.pb.binary.go> a code:Module ;
    code:name "proto/private/pbconfig/config.pb.binary.go" ;
    code:description "Config.Pb.Binary module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
