...
/*
# Module: internal/controller/manager.go
Manager module for internal layer
...
<internal/controller/manager.go> a code:Module ;
    code:name "internal/controller/manager.go" ;
    code:description "Manager module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :Manager, :NewManager ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package controller
