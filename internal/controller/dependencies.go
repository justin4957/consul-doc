...
/*
# Module: internal/controller/dependencies.go
Dependencies module for internal layer
...
<internal/controller/dependencies.go> a code:Module ;
    code:name "internal/controller/dependencies.go" ;
    code:description "Dependencies module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
