...
/*
# Module: internal/controller/dependency/dependencymock/mock_CacheIDModifier.go
Mock Cacheidmodifier module for internal layer
...
## Exports
CacheIDModifier, NewCacheIDModifier

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/controller/dependency/dependencymock/mock_CacheIDModifier.go> a code:Module ;
    code:name "internal/controller/dependency/dependencymock/mock_CacheIDModifier.go" ;
    code:description "Mock Cacheidmodifier module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :CacheIDModifier, :NewCacheIDModifier ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
