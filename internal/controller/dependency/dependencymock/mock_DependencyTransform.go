...
/*
# Module: internal/controller/dependency/dependencymock/mock_DependencyTransform.go
Mock Dependencytransform module for internal layer
...
## Exports
DependencyTransform, NewDependencyTransform

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/controller/dependency/dependencymock/mock_DependencyTransform.go> a code:Module ;
    code:name "internal/controller/dependency/dependencymock/mock_DependencyTransform.go" ;
    code:description "Mock Dependencytransform module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :DependencyTransform, :NewDependencyTransform ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
