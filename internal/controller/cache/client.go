...
/*
# Module: internal/controller/cache/client.go
...
<internal/controller/cache/client.go> a code:Module ;
    code:name "internal/controller/cache/client.go" ;
