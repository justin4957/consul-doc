...
/*
# Module: internal/controller/cache/cache.go
...
## Exports
Cache, New, Query, ReadOnlyCache, ResourceIterator, WriteCache

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/controller/cache/cache.go> a code:Module ;
    code:name "internal/controller/cache/cache.go" ;
    ...
    code:exports :Cache, :New, :Query, :ReadOnlyCache, :ResourceIterator, :WriteCache ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
package cache
