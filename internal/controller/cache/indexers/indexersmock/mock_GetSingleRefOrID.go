...
/*
# Module: internal/controller/cache/indexers/indexersmock/mock_GetSingleRefOrID.go
Mock Getsinglereforid module for internal layer
...
## Exports
GetSingleRefOrID, NewGetSingleRefOrID

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/controller/cache/indexers/indexersmock/mock_GetSingleRefOrID.go> a code:Module ;
    code:name "internal/controller/cache/indexers/indexersmock/mock_GetSingleRefOrID.go" ;
    code:description "Mock Getsinglereforid module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :GetSingleRefOrID, :NewGetSingleRefOrID ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
