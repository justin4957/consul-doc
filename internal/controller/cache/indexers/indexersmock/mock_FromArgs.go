...
/*
# Module: internal/controller/cache/indexers/indexersmock/mock_FromArgs.go
Mock Fromargs module for internal layer

## Tags
internal

## Exports
FromArgs, NewFromArgs

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/controller/cache/indexers/indexersmock/mock_FromArgs.go> a code:Module ;
    code:name "internal/controller/cache/indexers/indexersmock/mock_FromArgs.go" ;
    code:description "Mock Fromargs module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :FromArgs, :NewFromArgs ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
