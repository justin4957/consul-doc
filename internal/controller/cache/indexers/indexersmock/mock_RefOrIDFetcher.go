...
/*
# Module: internal/controller/cache/indexers/indexersmock/mock_RefOrIDFetcher.go
Mock Reforidfetcher module for internal layer
...
## Exports
NewRefOrIDFetcher, RefOrIDFetcher

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/controller/cache/indexers/indexersmock/mock_RefOrIDFetcher.go> a code:Module ;
    code:name "internal/controller/cache/indexers/indexersmock/mock_RefOrIDFetcher.go" ;
    code:description "Mock Reforidfetcher module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :NewRefOrIDFetcher, :RefOrIDFetcher ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
*/
