...
/*
# Module: internal/controller/cache/cachemock/mock_Query.go
Mock Query module for internal layer
...
<internal/controller/cache/cachemock/mock_Query.go> a code:Module ;
    code:name "internal/controller/cache/cachemock/mock_Query.go" ;
    code:description "Mock Query module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
