...
/*
# Module: internal/controller/controllermock/mock_CacheIDModifier.go
...
<internal/controller/controllermock/mock_CacheIDModifier.go> a code:Module ;
    code:name "internal/controller/controllermock/mock_CacheIDModifier.go" ;
