...
/*
# Module: internal/controller/controllermock/mock_task.go
Mock Task module for internal layer
...
<internal/controller/controllermock/mock_task.go> a code:Module ;
    code:name "internal/controller/controllermock/mock_task.go" ;
    code:description "Mock Task module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
