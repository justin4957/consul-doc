...
/*
# Module: internal/tools/proto-gen-rpc-glue/e2e/consul/proto/pbcommon/common.pb.go
...
## Exports
EnterpriseMeta, QueryMeta, QueryOptions, RaftIndex, ReadRequest, TargetDatacenter, WriteRequest

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/tools/proto-gen-rpc-glue/e2e/consul/proto/pbcommon/common.pb.go> a code:Module ;
    code:name "internal/tools/proto-gen-rpc-glue/e2e/consul/proto/pbcommon/common.pb.go" ;
    code:description "Common.Pb module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:exports :EnterpriseMeta, :QueryMeta, :QueryOptions, :RaftIndex, :ReadRequest, :TargetDatacenter, :WriteRequest ;
