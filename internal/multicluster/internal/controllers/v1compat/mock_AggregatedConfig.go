...
/*
# Module: internal/multicluster/internal/controllers/v1compat/mock_AggregatedConfig.go
Mock Aggregatedconfig module for internal layer
...
## Exports
MockAggregatedConfig, NewMockAggregatedConfig

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<internal/multicluster/internal/controllers/v1compat/mock_AggregatedConfig.go> a code:Module ;
    code:name "internal/multicluster/internal/controllers/v1compat/mock_AggregatedConfig.go" ;
    code:description "Mock Aggregatedconfig module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :MockAggregatedConfig, :NewMockAggregatedConfig ;
