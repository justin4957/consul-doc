...
/*
# Module: internal/protohcl/blocks.go
Blocks module for internal layer
...
<internal/protohcl/blocks.go> a code:Module ;
    code:name "internal/protohcl/blocks.go" ;
    code:description "Blocks module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
