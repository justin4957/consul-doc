...
/*
# Module: grpcmocks/proto-public/pbconnectca/mock_ConnectCAService_WatchRootsServer.go
Mock Connectcaservice Watchrootsserver module for internal layer
...
<grpcmocks/proto-public/pbconnectca/mock_ConnectCAService_WatchRootsServer.go> a code:Module ;
    code:name "grpcmocks/proto-public/pbconnectca/mock_ConnectCAService_WatchRootsServer.go" ;
    code:description "Mock Connectcaservice Watchrootsserver module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
