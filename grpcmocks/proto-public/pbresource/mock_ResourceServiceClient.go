...
/*
# Module: grpcmocks/proto-public/pbresource/mock_ResourceServiceClient.go
Mock Resourceserviceclient module for internal layer
...
## Exports
NewResourceServiceClient, ResourceServiceClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<grpcmocks/proto-public/pbresource/mock_ResourceServiceClient.go> a code:Module ;
    code:name "grpcmocks/proto-public/pbresource/mock_ResourceServiceClient.go" ;
    code:description "Mock Resourceserviceclient module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :NewResourceServiceClient, :ResourceServiceClient ;
