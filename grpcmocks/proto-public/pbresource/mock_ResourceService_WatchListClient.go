...
/*
# Module: grpcmocks/proto-public/pbresource/mock_ResourceService_WatchListClient.go
Mock Resourceservice Watchlistclient module for internal layer
...
<grpcmocks/proto-public/pbresource/mock_ResourceService_WatchListClient.go> a code:Module ;
    code:name "grpcmocks/proto-public/pbresource/mock_ResourceService_WatchListClient.go" ;
    code:description "Mock Resourceservice Watchlistclient module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :NewResourceService, :ResourceService ;
