...
/*
# Module: grpcmocks/proto-public/pbserverdiscovery/mock_ServerDiscoveryService_WatchServersClient.go
Mock Serverdiscoveryservice Watchserversclient module for internal layer
...
<grpcmocks/proto-public/pbserverdiscovery/mock_ServerDiscoveryService_WatchServersClient.go> a code:Module ;
    code:name "grpcmocks/proto-public/pbserverdiscovery/mock_ServerDiscoveryService_WatchServersClient.go" ;
    code:description "Mock Serverdiscoveryservice Watchserversclient module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
