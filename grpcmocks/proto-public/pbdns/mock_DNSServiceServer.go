...
/*
# Module: grpcmocks/proto-public/pbdns/mock_DNSServiceServer.go
Mock Dnsserviceserver module for internal layer
...
## Exports
DNSServiceServer, NewDNSServiceServer

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<grpcmocks/proto-public/pbdns/mock_DNSServiceServer.go> a code:Module ;
    code:name "grpcmocks/proto-public/pbdns/mock_DNSServiceServer.go" ;
    code:description "Mock Dnsserviceserver module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:linksTo [
    ...
    code:exports :DNSServiceServer, :NewDNSServiceServer ;
