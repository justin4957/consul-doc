...
/*
# Module: troubleshoot/proxy/z_xds_packages.go
Z Xds Packages module for internal layer
...
<troubleshoot/proxy/z_xds_packages.go> a code:Module ;
    code:name "troubleshoot/proxy/z_xds_packages.go" ;
    code:description "Z Xds Packages module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
