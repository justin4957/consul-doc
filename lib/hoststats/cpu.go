...
/*
# Module: lib/hoststats/cpu.go
Cpu module for internal layer
...
<lib/hoststats/cpu.go> a code:Module ;
    code:name "lib/hoststats/cpu.go" ;
    code:description "Cpu module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
