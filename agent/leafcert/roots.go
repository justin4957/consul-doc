...
/*
# Module: agent/leafcert/roots.go
Roots module for agent layer
...
<agent/leafcert/roots.go> a code:Module ;
    code:name "agent/leafcert/roots.go" ;
    code:description "Roots module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
