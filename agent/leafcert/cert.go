...
/*
# Module: agent/leafcert/cert.go
Cert module for agent layer
...
<agent/leafcert/cert.go> a code:Module ;
    code:name "agent/leafcert/cert.go" ;
    code:description "Cert module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
