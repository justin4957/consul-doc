...
/*
# Module: agent/grpc-internal/resolver/resolver.go
Resolver module for agent layer
...
## Exports
Config, DCPrefix, NewServerResolverBuilder, ServerResolverBuilder

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/grpc-internal/resolver/resolver.go> a code:Module ;
    code:name "agent/grpc-internal/resolver/resolver.go" ;
    code:description "Resolver module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :Config, :DCPrefix, :NewServerResolverBuilder, :ServerResolverBuilder ;
