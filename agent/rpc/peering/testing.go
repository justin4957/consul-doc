...
/*
# Module: agent/rpc/peering/testing.go
...
## Exports
TestPeering, TestPeeringToken

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/rpc/peering/testing.go> a code:Module ;
    code:name "agent/rpc/peering/testing.go" ;
    ...
    code:exports :TestPeering, :TestPeeringToken ;
