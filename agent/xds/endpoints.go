...
/*
# Module: agent/xds/endpoints.go
Endpoints module for agent layer
...
<agent/xds/endpoints.go> a code:Module ;
    code:name "agent/xds/endpoints.go" ;
    code:description "Endpoints module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
