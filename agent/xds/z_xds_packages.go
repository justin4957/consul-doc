...
/*
# Module: agent/xds/z_xds_packages.go
Z Xds Packages module for agent layer
...
<agent/xds/z_xds_packages.go> a code:Module ;
    code:name "agent/xds/z_xds_packages.go" ;
    code:description "Z Xds Packages module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
