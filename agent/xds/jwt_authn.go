...
/*
# Module: agent/xds/jwt_authn.go
Jwt Authn module for agent layer
...
<agent/xds/jwt_authn.go> a code:Module ;
    code:name "agent/xds/jwt_authn.go" ;
    code:description "Jwt Authn module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
