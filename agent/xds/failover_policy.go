...
/*
# Module: agent/xds/failover_policy.go
Failover Policy module for agent layer
...
<agent/xds/failover_policy.go> a code:Module ;
    code:name "agent/xds/failover_policy.go" ;
    code:description "Failover Policy module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
