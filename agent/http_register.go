...
/*
# Module: agent/http_register.go
Http Register module for agent layer
...
<agent/http_register.go> a code:Module ;
    code:name "agent/http_register.go" ;
    code:description "Http Register module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
