...
/*
# Module: agent/config_endpoint.go
Config Endpoint module for agent layer
...
## Exports
ConfigEntryNotFoundErr

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/config_endpoint.go> a code:Module ;
    code:name "agent/config_endpoint.go" ;
    code:description "Config Endpoint module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :ConfigEntryNotFoundErr ;
