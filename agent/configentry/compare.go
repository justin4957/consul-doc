...
/*
# Module: agent/configentry/compare.go
Compare module for agent layer
...
## Exports
EqualID, Less, SameHash, SortSlice

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/configentry/compare.go> a code:Module ;
    code:name "agent/configentry/compare.go" ;
    code:description "Compare module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :EqualID, :Less, :SameHash, :SortSlice ;
