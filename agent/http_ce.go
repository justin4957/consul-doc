...
/*
# Module: agent/http_ce.go
Http Ce module for agent layer
...
<agent/http_ce.go> a code:Module ;
    code:name "agent/http_ce.go" ;
    code:description "Http Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
