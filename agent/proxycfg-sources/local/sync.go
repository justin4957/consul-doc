...
/*
# Module: agent/proxycfg-sources/local/sync.go
Sync module for agent layer
...
## Exports
ConfigManager, Sync, SyncConfig

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/proxycfg-sources/local/sync.go> a code:Module ;
    code:name "agent/proxycfg-sources/local/sync.go" ;
    code:description "Sync module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :ConfigManager, :Sync, :SyncConfig ;
