...
/*
# Module: agent/proxycfg-sources/local/mock_ConfigManager.go
...
<agent/proxycfg-sources/local/mock_ConfigManager.go> a code:Module ;
    code:name "agent/proxycfg-sources/local/mock_ConfigManager.go" ;
