...
/*
# Module: agent/proxycfg-sources/catalog/mock_ConfigManager.go
Mock Configmanager module for agent layer
...
<agent/proxycfg-sources/catalog/mock_ConfigManager.go> a code:Module ;
    code:name "agent/proxycfg-sources/catalog/mock_ConfigManager.go" ;
    code:description "Mock Configmanager module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MockConfigManager, :NewMockConfigManager ;
