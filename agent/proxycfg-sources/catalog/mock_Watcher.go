...
/*
# Module: agent/proxycfg-sources/catalog/mock_Watcher.go
Mock Watcher module for agent layer
...
<agent/proxycfg-sources/catalog/mock_Watcher.go> a code:Module ;
    code:name "agent/proxycfg-sources/catalog/mock_Watcher.go" ;
    code:description "Mock Watcher module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MockWatcher, :NewMockWatcher ;
