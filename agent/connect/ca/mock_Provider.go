...
/*
# Module: agent/connect/ca/mock_Provider.go
Mock Provider module for agent layer
...
<agent/connect/ca/mock_Provider.go> a code:Module ;
    code:name "agent/connect/ca/mock_Provider.go" ;
    code:description "Mock Provider module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockProvider, :NewMockProvider ;
