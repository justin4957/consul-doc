...
/*
# Module: agent/connect/ca/provider_vault_auth.go
Provider Vault Auth module for agent layer
...
## Exports
LoginDataGeneratorFn, NewVaultAPIAuthClient, VaultAuthClient, VaultAuthenticator

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/connect/ca/provider_vault_auth.go> a code:Module ;
    code:name "agent/connect/ca/provider_vault_auth.go" ;
    code:description "Provider Vault Auth module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :LoginDataGeneratorFn, :NewVaultAPIAuthClient, :VaultAuthClient, :VaultAuthenticator ;
