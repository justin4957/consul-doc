...
/*
# Module: agent/connect/ca/provider_vault_auth_approle.go
Provider Vault Auth Approle module for agent layer
...
## Exports
ArLoginDataGen, NewAppRoleAuthClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/connect/ca/provider_vault_auth_approle.go> a code:Module ;
    code:name "agent/connect/ca/provider_vault_auth_approle.go" ;
    code:description "Provider Vault Auth Approle module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :ArLoginDataGen, :NewAppRoleAuthClient ;
