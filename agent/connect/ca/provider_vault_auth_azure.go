...
/*
# Module: agent/connect/ca/provider_vault_auth_azure.go
Provider Vault Auth Azure module for agent layer
...
## Exports
AzureLoginDataGen, Compute, NewAzureAuthClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/connect/ca/provider_vault_auth_azure.go> a code:Module ;
    code:name "agent/connect/ca/provider_vault_auth_azure.go" ;
    code:description "Provider Vault Auth Azure module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :AzureLoginDataGen, :Compute, :NewAzureAuthClient ;
