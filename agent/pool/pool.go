...
/*
# Module: agent/pool/pool.go
Pool module for agent layer
...
## Exports
BlockableQuery, Conn, ConnPool, DefaultDialTimeout, DialRPCViaMeshGateway, HalfCloser, StreamClient

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/pool/pool.go> a code:Module ;
    code:name "agent/pool/pool.go" ;
    code:description "Pool module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :BlockableQuery, :Conn, :ConnPool, :DefaultDialTimeout, :DialRPCViaMeshGateway, :HalfCloser, :StreamClient ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
package pool
