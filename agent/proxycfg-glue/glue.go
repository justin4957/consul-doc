...
/*
# Module: agent/proxycfg-glue/glue.go
Glue module for agent layer
...
## Exports
CacheCARoots, CacheDatacenters, CachePrepraredQuery, CacheServiceGateways, ServerDataSourceDeps, Store

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/proxycfg-glue/glue.go> a code:Module ;
    code:name "agent/proxycfg-glue/glue.go" ;
    code:description "Glue module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :CacheCARoots, :CacheDatacenters, :CachePrepraredQuery, :CacheServiceGateways, :ServerDataSourceDeps, :Store ;
