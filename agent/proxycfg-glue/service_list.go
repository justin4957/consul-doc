...
/*
# Module: agent/proxycfg-glue/service_list.go
Service List module for agent layer
...
## Exports
CacheServiceList, ServerServiceList

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/proxycfg-glue/service_list.go> a code:Module ;
    code:name "agent/proxycfg-glue/service_list.go" ;
    code:description "Service List module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :CacheServiceList, :ServerServiceList ;
