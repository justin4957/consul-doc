...
/*
# Module: agent/event_endpoint.go
Event Endpoint module for agent layer
...
<agent/event_endpoint.go> a code:Module ;
    code:name "agent/event_endpoint.go" ;
    code:description "Event Endpoint module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
