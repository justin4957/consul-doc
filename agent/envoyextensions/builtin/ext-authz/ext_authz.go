...
/*
# Module: agent/envoyextensions/builtin/ext-authz/ext_authz.go
Ext Authz module for agent layer
...
<agent/envoyextensions/builtin/ext-authz/ext_authz.go> a code:Module ;
    code:name "agent/envoyextensions/builtin/ext-authz/ext_authz.go" ;
    code:description "Ext Authz module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "api" ;
