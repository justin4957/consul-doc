...
/*
# Module: agent/proxycfg/testing_mesh_gateway.go
Testing Mesh Gateway module for agent layer
...
## Exports
TestConfigSnapshotMeshGateway, TestConfigSnapshotPeeredMeshGateway

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/proxycfg/testing_mesh_gateway.go> a code:Module ;
    code:name "agent/proxycfg/testing_mesh_gateway.go" ;
    code:description "Testing Mesh Gateway module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :TestConfigSnapshotMeshGateway, :TestConfigSnapshotPeeredMeshGateway ;
