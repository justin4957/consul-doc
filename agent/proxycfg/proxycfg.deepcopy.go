...
/*
# Module: agent/proxycfg/proxycfg.deepcopy.go
Proxycfg.Deepcopy module for agent layer
...
<agent/proxycfg/proxycfg.deepcopy.go> a code:Module ;
    code:name "agent/proxycfg/proxycfg.deepcopy.go" ;
    code:description "Proxycfg.Deepcopy module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
