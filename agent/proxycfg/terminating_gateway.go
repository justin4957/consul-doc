...
/*
# Module: agent/proxycfg/terminating_gateway.go
Terminating Gateway module for agent layer
...
<agent/proxycfg/terminating_gateway.go> a code:Module ;
    code:name "agent/proxycfg/terminating_gateway.go" ;
    code:description "Terminating Gateway module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
