...
/*
# Module: agent/cache-types/intention_match.go
Intention Match module for agent layer
...
## Exports
IntentionMatch, IntentionMatchName

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/cache-types/intention_match.go> a code:Module ;
    code:name "agent/cache-types/intention_match.go" ;
    code:description "Intention Match module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :IntentionMatch, :IntentionMatchName ;
