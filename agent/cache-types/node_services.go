...
/*
# Module: agent/cache-types/node_services.go
Node Services module for agent layer
...
## Exports
NodeServices, NodeServicesName

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/cache-types/node_services.go> a code:Module ;
    code:name "agent/cache-types/node_services.go" ;
    code:description "Node Services module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :NodeServices, :NodeServicesName ;
