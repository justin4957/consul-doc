...
/*
# Module: agent/cache-types/gateway_services.go
...
## Exports
GatewayServices, GatewayServicesName

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/cache-types/gateway_services.go> a code:Module ;
    code:name "agent/cache-types/gateway_services.go" ;
    ...
    code:exports :GatewayServices, :GatewayServicesName ;
