...
/*
# Module: agent/cache-types/peered_upstreams.go
...
## Exports
PeeredUpstreams, PeeredUpstreamsName

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/cache-types/peered_upstreams.go> a code:Module ;
    code:name "agent/cache-types/peered_upstreams.go" ;
    ...
    code:exports :PeeredUpstreams, :PeeredUpstreamsName ;
