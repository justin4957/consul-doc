...
/*
# Module: agent/cache-types/catalog_datacenters.go
Catalog Datacenters module for agent layer
...
## Exports
CatalogDatacenters, CatalogDatacentersName

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/cache-types/catalog_datacenters.go> a code:Module ;
    code:name "agent/cache-types/catalog_datacenters.go" ;
    code:description "Catalog Datacenters module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :CatalogDatacenters, :CatalogDatacentersName ;
