...
/*
# Module: agent/cache-types/intention_upstreams.go
...
## Exports
IntentionUpstreams, IntentionUpstreamsName

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/cache-types/intention_upstreams.go> a code:Module ;
    code:name "agent/cache-types/intention_upstreams.go" ;
    ...
    code:exports :IntentionUpstreams, :IntentionUpstreamsName ;
