...
/*
# Module: agent/health_endpoint.go
Health Endpoint module for agent layer
...
<agent/health_endpoint.go> a code:Module ;
    code:name "agent/health_endpoint.go" ;
    code:description "Health Endpoint module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
