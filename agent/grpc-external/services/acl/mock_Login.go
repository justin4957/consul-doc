...
/*
# Module: agent/grpc-external/services/acl/mock_Login.go
Mock Login module for agent layer
...
## Exports
MockLogin, NewMockLogin

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/grpc-external/services/acl/mock_Login.go> a code:Module ;
    code:name "agent/grpc-external/services/acl/mock_Login.go" ;
    code:description "Mock Login module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MockLogin, :NewMockLogin ;
