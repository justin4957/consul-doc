...
/*
# Module: agent/grpc-external/services/acl/logout.go
Logout module for agent layer
...
<agent/grpc-external/services/acl/logout.go> a code:Module ;
    code:name "agent/grpc-external/services/acl/logout.go" ;
    code:description "Logout module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
