...
/*
# Module: agent/grpc-external/services/serverdiscovery/mock_ACLResolver.go
Mock Aclresolver module for agent layer
...
## Tags
access-control, agent, api, authorization, communication, discovery, dns, grpc, networking, security

## Exports
MockACLResolver, NewMockACLResolver

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/grpc-external/services/serverdiscovery/mock_ACLResolver.go> a code:Module ;
    code:name "agent/grpc-external/services/serverdiscovery/mock_ACLResolver.go" ;
    code:description "Mock Aclresolver module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :MockACLResolver, :NewMockACLResolver ;
    code:tags "access-control", "agent", "api", "authorization", "communication", "discovery", "dns", "grpc", "networking", "security" .
<!-- End LinkedDoc RDF -->
*/
