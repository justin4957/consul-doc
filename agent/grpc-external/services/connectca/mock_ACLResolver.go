...
/*
# Module: agent/grpc-external/services/connectca/mock_ACLResolver.go
...
## Tags
access-control, agent, api, authorization, communication, grpc, mtls, networking, security, service-mesh
...
<agent/grpc-external/services/connectca/mock_ACLResolver.go> a code:Module ;
    code:name "agent/grpc-external/services/connectca/mock_ACLResolver.go" ;
    ...
    code:tags "access-control", "agent", "api", "authorization", "communication", "grpc", "mtls", "networking", "security", "service-mesh" .
<!-- End LinkedDoc RDF -->
*/
package connectca
