...
/*
# Module: agent/grpc-external/services/peerstream/mock_ACLResolver.go
...
<agent/grpc-external/services/peerstream/mock_ACLResolver.go> a code:Module ;
    code:name "agent/grpc-external/services/peerstream/mock_ACLResolver.go" ;
