...
/*
# Module: agent/grpc-external/services/peerstream/stream_tracker.go
Stream Tracker module for agent layer
...
## Exports
MutableStatus, NewTracker, Status, Tracker

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/grpc-external/services/peerstream/stream_tracker.go> a code:Module ;
    code:name "agent/grpc-external/services/peerstream/stream_tracker.go" ;
    code:description "Stream Tracker module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MutableStatus, :NewTracker, :Status, :Tracker ;
