...
/*
# Module: agent/grpc-external/services/resource/watch.go
...
<agent/grpc-external/services/resource/watch.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/watch.go" ;
