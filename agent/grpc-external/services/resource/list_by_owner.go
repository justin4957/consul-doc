...
/*
# Module: agent/grpc-external/services/resource/list_by_owner.go
List By Owner module for agent layer
...
<agent/grpc-external/services/resource/list_by_owner.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/list_by_owner.go" ;
    code:description "List By Owner module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
