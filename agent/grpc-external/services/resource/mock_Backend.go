...
/*
# Module: agent/grpc-external/services/resource/mock_Backend.go
Mock Backend module for agent layer
...
<agent/grpc-external/services/resource/mock_Backend.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/mock_Backend.go" ;
    code:description "Mock Backend module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MockBackend, :NewMockBackend ;
