...
/*
# Module: agent/grpc-external/services/resource/mock_TenancyBridge.go
Mock Tenancybridge module for agent layer

## Tags
agent, api, communication, grpc, networking

## Exports
MockTenancyBridge, NewMockTenancyBridge

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/grpc-external/services/resource/mock_TenancyBridge.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/mock_TenancyBridge.go" ;
    code:description "Mock Tenancybridge module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockTenancyBridge, :NewMockTenancyBridge ;
