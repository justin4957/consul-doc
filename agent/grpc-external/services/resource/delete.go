...
/*
# Module: agent/grpc-external/services/resource/delete.go
Delete module for agent layer
...
<agent/grpc-external/services/resource/delete.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/delete.go" ;
    code:description "Delete module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
