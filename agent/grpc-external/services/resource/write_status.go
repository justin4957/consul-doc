...
/*
# Module: agent/grpc-external/services/resource/write_status.go
Write Status module for agent layer
...
<agent/grpc-external/services/resource/write_status.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/write_status.go" ;
    code:description "Write Status module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
