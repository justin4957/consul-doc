...
/*
# Module: agent/grpc-external/services/resource/list.go
List module for agent layer
...
<agent/grpc-external/services/resource/list.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/list.go" ;
    code:description "List module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
