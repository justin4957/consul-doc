...
/*
# Module: agent/grpc-external/services/resource/mock_Registry.go
Mock Registry module for agent layer
...
<agent/grpc-external/services/resource/mock_Registry.go> a code:Module ;
    code:name "agent/grpc-external/services/resource/mock_Registry.go" ;
    code:description "Mock Registry module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MockRegistry, :NewMockRegistry ;
