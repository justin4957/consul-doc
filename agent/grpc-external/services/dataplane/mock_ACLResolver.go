...
/*
# Module: agent/grpc-external/services/dataplane/mock_ACLResolver.go
...
<agent/grpc-external/services/dataplane/mock_ACLResolver.go> a code:Module ;
    code:name "agent/grpc-external/services/dataplane/mock_ACLResolver.go" ;
