...
/*
# Module: agent/structs/config_entry_intentions.go
Config Entry Intentions module for agent layer
...
## Exports
IntentionHTTPHeaderPermission, IntentionHTTPPermission, IntentionJWTClaimVerification, IntentionJWTProvider, IntentionJWTRequirement, IntentionPermission, MigrateIntentions, ServiceIntentionsConfigEntry, SourceIntention

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/structs/config_entry_intentions.go> a code:Module ;
    code:name "agent/structs/config_entry_intentions.go" ;
    code:description "Config Entry Intentions module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :IntentionHTTPHeaderPermission, :IntentionHTTPPermission, :IntentionJWTClaimVerification, :IntentionJWTProvider, :IntentionJWTRequirement, :IntentionPermission, :MigrateIntentions, :ServiceIntentionsConfigEntry, :SourceIntention ;
