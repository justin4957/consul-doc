...
/*
# Module: agent/structs/structs.deepcopy.go
Structs.Deepcopy module for agent layer
...
<agent/structs/structs.deepcopy.go> a code:Module ;
    code:name "agent/structs/structs.deepcopy.go" ;
    code:description "Structs.Deepcopy module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "types" ;
