...
/*
# Module: agent/structs/config_entry_exports.go
Config Entry Exports module for agent layer
...
<agent/structs/config_entry_exports.go> a code:Module ;
    code:name "agent/structs/config_entry_exports.go" ;
    code:description "Config Entry Exports module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
