...
/*
# Module: agent/hcp/client/mock_Client.go
Mock Client module for agent layer
...
<agent/hcp/client/mock_Client.go> a code:Module ;
    code:name "agent/hcp/client/mock_Client.go" ;
    code:description "Mock Client module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockClient, :NewMockClient ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
package client
