...
/*
# Module: agent/hcp/mock_Manager.go
Mock Manager module for agent layer
...
<agent/hcp/mock_Manager.go> a code:Module ;
    code:name "agent/hcp/mock_Manager.go" ;
    code:description "Mock Manager module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :MockManager, :NewMockManager ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
package hcp
