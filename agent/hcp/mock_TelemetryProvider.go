...
/*
# Module: agent/hcp/mock_TelemetryProvider.go
Mock Telemetryprovider module for agent layer

## Tags
agent

## Exports
MockTelemetryProvider, NewMockTelemetryProvider

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/hcp/mock_TelemetryProvider.go> a code:Module ;
    code:name "agent/hcp/mock_TelemetryProvider.go" ;
    code:description "Mock Telemetryprovider module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockTelemetryProvider, :NewMockTelemetryProvider ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
package hcp
