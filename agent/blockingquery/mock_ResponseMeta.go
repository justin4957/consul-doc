...
/*
# Module: agent/blockingquery/mock_ResponseMeta.go
Mock Responsemeta module for agent layer

## Tags
agent

## Exports
MockResponseMeta, NewMockResponseMeta

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/blockingquery/mock_ResponseMeta.go> a code:Module ;
    code:name "agent/blockingquery/mock_ResponseMeta.go" ;
    code:description "Mock Responsemeta module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockResponseMeta, :NewMockResponseMeta ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
