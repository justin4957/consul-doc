...
/*
# Module: agent/blockingquery/mock_RequestOptions.go
Mock Requestoptions module for agent layer

## Tags
agent

## Exports
MockRequestOptions, NewMockRequestOptions

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/blockingquery/mock_RequestOptions.go> a code:Module ;
    code:name "agent/blockingquery/mock_RequestOptions.go" ;
    code:description "Mock Requestoptions module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockRequestOptions, :NewMockRequestOptions ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
