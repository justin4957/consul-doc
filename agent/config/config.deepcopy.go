...
/*
# Module: agent/config/config.deepcopy.go
Config.Deepcopy module for agent layer
...
<agent/config/config.deepcopy.go> a code:Module ;
    code:name "agent/config/config.deepcopy.go" ;
    code:description "Config.Deepcopy module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
