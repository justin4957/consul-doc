...
/*
# Module: agent/config/flagset.go
Flagset module for agent layer
...
<agent/config/flagset.go> a code:Module ;
    code:name "agent/config/flagset.go" ;
    code:description "Flagset module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
