...
/*
# Module: agent/consul/snapshot_endpoint.go
...
<agent/consul/snapshot_endpoint.go> a code:Module ;
    code:name "agent/consul/snapshot_endpoint.go" ;
