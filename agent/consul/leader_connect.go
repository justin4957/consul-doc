...
/*
# Module: agent/consul/leader_connect.go
Leader Connect module for agent layer

## Linked Modules
- [agent/consul/gateways](../agent/consul/gateways)
...
<agent/consul/leader_connect.go> a code:Module ;
    code:name "agent/consul/leader_connect.go" ;
    code:description "Leader Connect module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "agent/consul/gateways" ;
        code:path "../agent/consul/gateways"
    ], [
