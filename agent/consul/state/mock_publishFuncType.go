...
/*
# Module: agent/consul/state/mock_publishFuncType.go
Mock Publishfunctype module for agent layer
...
<agent/consul/state/mock_publishFuncType.go> a code:Module ;
    code:name "agent/consul/state/mock_publishFuncType.go" ;
    code:description "Mock Publishfunctype module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
