...
/*
# Module: agent/consul/state/config_entry.go
...
## Exports
ConfigEntryKindQuery, ConfigEntryLinkIndex

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/state/config_entry.go> a code:Module ;
    code:name "agent/consul/state/config_entry.go" ;
    ...
    code:exports :ConfigEntryKindQuery, :ConfigEntryLinkIndex ;
