...
/*
# Module: agent/consul/state/query.go
Query module for agent layer
...
## Exports
AuthMethodQuery, BoolQuery, KeyValueQuery, MultiQuery, Query

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/state/query.go> a code:Module ;
    code:name "agent/consul/state/query.go" ;
    code:description "Query module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :AuthMethodQuery, :BoolQuery, :KeyValueQuery, :MultiQuery, :Query ;
