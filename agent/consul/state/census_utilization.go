...
/*
# Module: agent/consul/state/census_utilization.go
Census Utilization module for agent layer
...
<agent/consul/state/census_utilization.go> a code:Module ;
    code:name "agent/consul/state/census_utilization.go" ;
    code:description "Census Utilization module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
