...
/*
# Module: agent/consul/state/schema.go
Schema module for agent layer
...
<agent/consul/state/schema.go> a code:Module ;
    code:name "agent/consul/state/schema.go" ;
    code:description "Schema module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :IndexEntry ;
