...
/*
# Module: agent/consul/state/config_entry_exported_services.go
Config Entry Exported Services module for agent layer
...
## Exports
SimplifiedExportedServices

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/state/config_entry_exported_services.go> a code:Module ;
    code:name "agent/consul/state/config_entry_exported_services.go" ;
    code:description "Config Entry Exported Services module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :SimplifiedExportedServices ;
