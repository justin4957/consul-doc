...
/*
# Module: agent/consul/state/query_ce.go
Query Ce module for agent layer
...
<agent/consul/state/query_ce.go> a code:Module ;
    code:name "agent/consul/state/query_ce.go" ;
    code:description "Query Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
