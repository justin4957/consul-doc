...
/*
# Module: agent/consul/state/config_entry_ce.go
Config Entry Ce module for agent layer
...
<agent/consul/state/config_entry_ce.go> a code:Module ;
    code:name "agent/consul/state/config_entry_ce.go" ;
    code:description "Config Entry Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
