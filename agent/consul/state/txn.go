...
/*
# Module: agent/consul/state/txn.go
...
## Exports
UnsupportedFSMApplyPanicError

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/state/txn.go> a code:Module ;
    code:name "agent/consul/state/txn.go" ;
    ...
    code:exports :UnsupportedFSMApplyPanicError ;
