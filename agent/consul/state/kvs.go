...
/*
# Module: agent/consul/state/kvs.go
Kvs module for agent layer
...
<agent/consul/state/kvs.go> a code:Module ;
    code:name "agent/consul/state/kvs.go" ;
    code:description "Kvs module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
