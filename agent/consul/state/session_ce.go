...
/*
# Module: agent/consul/state/session_ce.go
Session Ce module for agent layer
...
<agent/consul/state/session_ce.go> a code:Module ;
    code:name "agent/consul/state/session_ce.go" ;
    code:description "Session Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
