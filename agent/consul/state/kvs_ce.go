...
/*
# Module: agent/consul/state/kvs_ce.go
Kvs Ce module for agent layer
...
<agent/consul/state/kvs_ce.go> a code:Module ;
    code:name "agent/consul/state/kvs_ce.go" ;
    code:description "Kvs Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
