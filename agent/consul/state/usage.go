...
/*
# Module: agent/consul/state/usage.go
Usage module for agent layer
...
## Exports
ConfigEntryUsage, KVUsage, NodeUsage, PeeringUsage, UsageEntry

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/state/usage.go> a code:Module ;
    code:name "agent/consul/state/usage.go" ;
    code:description "Usage module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :ConfigEntryUsage, :KVUsage, :NodeUsage, :PeeringUsage, :UsageEntry ;
