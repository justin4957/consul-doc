...
/*
# Module: agent/consul/fsm/log_verification_chunking_shim.go
Log Verification Chunking Shim module for agent layer
...
<agent/consul/fsm/log_verification_chunking_shim.go> a code:Module ;
    code:name "agent/consul/fsm/log_verification_chunking_shim.go" ;
    code:description "Log Verification Chunking Shim module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
