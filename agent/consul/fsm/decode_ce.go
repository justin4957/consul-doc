...
/*
# Module: agent/consul/fsm/decode_ce.go
Decode Ce module for agent layer
...
<agent/consul/fsm/decode_ce.go> a code:Module ;
    code:name "agent/consul/fsm/decode_ce.go" ;
    code:description "Decode Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
