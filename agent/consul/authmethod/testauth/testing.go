...
/*
# Module: agent/consul/authmethod/testauth/testing.go
...
## Exports
Config, GetSessionToken, InstallSessionToken, ResetSession, StartSession, Validator

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/authmethod/testauth/testing.go> a code:Module ;
    code:name "agent/consul/authmethod/testauth/testing.go" ;
    ...
    code:exports :Config, :GetSessionToken, :InstallSessionToken, :ResetSession, :StartSession, :Validator ;
