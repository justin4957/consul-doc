...
/*
# Module: agent/consul/authmethod/authmethods.go
Authmethods module for agent layer
...
## Exports
Cache, Identity, IsRegisteredType, NewValidator, ParseConfig, Register, Types, Validator, ValidatorFactory

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/authmethod/authmethods.go> a code:Module ;
    code:name "agent/consul/authmethod/authmethods.go" ;
    code:description "Authmethods module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :Cache, :Identity, :IsRegisteredType, :NewValidator, :ParseConfig, :Register, :Types, :Validator, :ValidatorFactory ;
