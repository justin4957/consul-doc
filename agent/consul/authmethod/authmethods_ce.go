...
/*
# Module: agent/consul/authmethod/authmethods_ce.go
Authmethods Ce module for agent layer
...
<agent/consul/authmethod/authmethods_ce.go> a code:Module ;
    code:name "agent/consul/authmethod/authmethods_ce.go" ;
    code:description "Authmethods Ce module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
