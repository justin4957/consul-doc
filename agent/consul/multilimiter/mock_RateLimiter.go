...
/*
# Module: agent/consul/multilimiter/mock_RateLimiter.go
Mock Ratelimiter module for agent layer
...
<agent/consul/multilimiter/mock_RateLimiter.go> a code:Module ;
    code:name "agent/consul/multilimiter/mock_RateLimiter.go" ;
    code:description "Mock Ratelimiter module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:exports :MockRateLimiter, :NewMockRateLimiter ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
