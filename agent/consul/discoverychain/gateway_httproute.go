...
/*
# Module: agent/consul/discoverychain/gateway_httproute.go
Gateway Httproute module for agent layer
...
<agent/consul/discoverychain/gateway_httproute.go> a code:Module ;
    code:name "agent/consul/discoverychain/gateway_httproute.go" ;
    code:description "Gateway Httproute module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
