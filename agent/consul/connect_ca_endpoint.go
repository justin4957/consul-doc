...
/*
# Module: agent/consul/connect_ca_endpoint.go
Connect Ca Endpoint module for agent layer
...
<agent/consul/connect_ca_endpoint.go> a code:Module ;
    code:name "agent/consul/connect_ca_endpoint.go" ;
    code:description "Connect Ca Endpoint module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
