...
/*
# Module: agent/consul/server_serf.go
Server Serf module for agent layer
...
<agent/consul/server_serf.go> a code:Module ;
    code:name "agent/consul/server_serf.go" ;
    code:description "Server Serf module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
