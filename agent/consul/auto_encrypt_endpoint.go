...
/*
# Module: agent/consul/auto_encrypt_endpoint.go
Auto Encrypt Endpoint module for agent layer
...
<agent/consul/auto_encrypt_endpoint.go> a code:Module ;
    code:name "agent/consul/auto_encrypt_endpoint.go" ;
    code:description "Auto Encrypt Endpoint module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
