...
/*
# Module: agent/consul/acl_replication.go
Acl Replication module for agent layer
...
<agent/consul/acl_replication.go> a code:Module ;
    code:name "agent/consul/acl_replication.go" ;
    code:description "Acl Replication module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
