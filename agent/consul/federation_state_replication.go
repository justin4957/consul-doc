...
/*
# Module: agent/consul/federation_state_replication.go
Federation State Replication module for agent layer
...
## Exports
FederationStateReplicator

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/federation_state_replication.go> a code:Module ;
    code:name "agent/consul/federation_state_replication.go" ;
    code:description "Federation State Replication module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :FederationStateReplicator ;
