...
/*
# Module: agent/consul/session_ttl.go
Session Ttl module for agent layer
...
## Exports
SessionGauges, SessionSummaries

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/session_ttl.go> a code:Module ;
    code:name "agent/consul/session_ttl.go" ;
    code:description "Session Ttl module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
    ...
    code:exports :SessionGauges, :SessionSummaries ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
package consul
