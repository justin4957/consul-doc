...
/*
# Module: agent/consul/flood.go
Flood module for agent layer
...
<agent/consul/flood.go> a code:Module ;
    code:name "agent/consul/flood.go" ;
    code:description "Flood module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
