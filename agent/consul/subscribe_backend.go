...
/*
# Module: agent/consul/subscribe_backend.go
Subscribe Backend module for agent layer

## Linked Modules
- [acl](../acl)
- [agent/consul/stream](../agent/consul/stream)
- [agent/grpc-internal/services/subscribe](../agent/grpc-internal/services/subscribe)
...
<agent/consul/subscribe_backend.go> a code:Module ;
    code:name "agent/consul/subscribe_backend.go" ;
    code:description "Subscribe Backend module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
        code:name "acl" ;
        ...
        code:path "../agent/grpc-internal/services/subscribe"
    ], [
