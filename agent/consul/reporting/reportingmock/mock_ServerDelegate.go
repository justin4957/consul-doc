...
/*
# Module: agent/consul/reporting/reportingmock/mock_ServerDelegate.go
Mock Serverdelegate module for agent layer
...
## Exports
NewServerDelegate, ServerDelegate

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/reporting/reportingmock/mock_ServerDelegate.go> a code:Module ;
    code:name "agent/consul/reporting/reportingmock/mock_ServerDelegate.go" ;
    code:description "Mock Serverdelegate module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :NewServerDelegate, :ServerDelegate ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
