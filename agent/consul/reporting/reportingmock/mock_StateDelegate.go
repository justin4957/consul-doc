...
/*
# Module: agent/consul/reporting/reportingmock/mock_StateDelegate.go
Mock Statedelegate module for agent layer
...
## Exports
NewStateDelegate, StateDelegate

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/reporting/reportingmock/mock_StateDelegate.go> a code:Module ;
    code:name "agent/consul/reporting/reportingmock/mock_StateDelegate.go" ;
    code:description "Mock Statedelegate module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :NewStateDelegate, :StateDelegate ;
