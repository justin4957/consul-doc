...
/*
# Module: agent/consul/server_log_verification.go
Server Log Verification module for agent layer
...
<agent/consul/server_log_verification.go> a code:Module ;
    code:name "agent/consul/server_log_verification.go" ;
    code:description "Server Log Verification module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
