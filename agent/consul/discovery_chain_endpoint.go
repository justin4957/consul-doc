...
/*
# Module: agent/consul/discovery_chain_endpoint.go
...
<agent/consul/discovery_chain_endpoint.go> a code:Module ;
    code:name "agent/consul/discovery_chain_endpoint.go" ;
