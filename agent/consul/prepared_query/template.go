...
/*
# Module: agent/consul/prepared_query/template.go
Template module for agent layer
...
## Exports
Compile, CompiledTemplate, IsTemplate

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<agent/consul/prepared_query/template.go> a code:Module ;
    code:name "agent/consul/prepared_query/template.go" ;
    code:description "Template module for agent layer" ;
    code:language "go" ;
    code:layer "agent" ;
    code:linksTo [
    ...
    code:exports :Compile, :CompiledTemplate, :IsTemplate ;
    code:tags "agent" .
<!-- End LinkedDoc RDF -->
*/
