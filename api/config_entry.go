...
/*
# Module: api/config_entry.go
Config Entry module for api layer

## Tags
api, client, configuration

## Exports
AccessLogsConfig, ConfigEntries, ConfigEntry, DecodeConfigEntry, DecodeConfigEntryFromJSON, DestinationConfig, EnvoyExtension, ExposeConfig, ExposePath, InstanceLevelRateLimits, InstanceLevelRouteRateLimits, LogSinkType, MakeConfigEntry, MeshGatewayConfig, MeshGatewayMode, MutualTLSMode, PassiveHealthCheck, ProxyConfigEntry, ProxyMode, RateLimits

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<api/config_entry.go> a code:Module ;
    code:name "api/config_entry.go" ;
    code:description "Config Entry module for api layer" ;
    code:language "go" ;
    code:layer "api" ;
    code:exports :AccessLogsConfig, :ConfigEntries, :ConfigEntry, :DecodeConfigEntry, :DecodeConfigEntryFromJSON, :DestinationConfig, :EnvoyExtension, :ExposeConfig, :ExposePath, :InstanceLevelRateLimits, :InstanceLevelRouteRateLimits, :LogSinkType, :MakeConfigEntry, :MeshGatewayConfig, :MeshGatewayMode, :MutualTLSMode, :PassiveHealthCheck, :ProxyConfigEntry, :ProxyMode, :RateLimits ;
