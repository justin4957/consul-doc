...
/*
# Module: api/config_entry_file_system_certificate.go
Config Entry File System Certificate module for api layer
...
<api/config_entry_file_system_certificate.go> a code:Module ;
    code:name "api/config_entry_file_system_certificate.go" ;
    code:description "Config Entry File System Certificate module for api layer" ;
    code:language "go" ;
    code:layer "api" ;
