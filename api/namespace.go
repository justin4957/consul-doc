...
/*
# Module: api/namespace.go
Namespace module for api layer

## Tags
api, client

## Exports
Namespace, NamespaceACLConfig, Namespaces

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<api/namespace.go> a code:Module ;
    code:name "api/namespace.go" ;
    code:description "Namespace module for api layer" ;
    code:language "go" ;
    code:layer "api" ;
    code:exports :Namespace, :NamespaceACLConfig, :Namespaces ;
