...
/*
# Module: command/login/login.go
Login module for cli layer
...
<command/login/login.go> a code:Module ;
    code:name "command/login/login.go" ;
    code:description "Login module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
