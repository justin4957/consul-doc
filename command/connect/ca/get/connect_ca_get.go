...
/*
# Module: command/connect/ca/get/connect_ca_get.go
Connect Ca Get module for cli layer
...
<command/connect/ca/get/connect_ca_get.go> a code:Module ;
    code:name "command/connect/ca/get/connect_ca_get.go" ;
    code:description "Connect Ca Get module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
