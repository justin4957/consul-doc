...
/*
# Module: command/connect/envoy/pipe-bootstrap/connect_envoy_pipe-bootstrap.go
Connect Envoy Pipe Bootstrap module for cli layer
...
<command/connect/envoy/pipe-bootstrap/connect_envoy_pipe-bootstrap.go> a code:Module ;
    code:name "command/connect/envoy/pipe-bootstrap/connect_envoy_pipe-bootstrap.go" ;
    code:description "Connect Envoy Pipe Bootstrap module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
