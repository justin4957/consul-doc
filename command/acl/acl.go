...
/*
# Module: command/acl/acl.go
Acl module for cli layer
...
<command/acl/acl.go> a code:Module ;
    code:name "command/acl/acl.go" ;
    code:description "Acl module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
