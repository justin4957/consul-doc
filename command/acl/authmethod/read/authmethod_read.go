...
/*
# Module: command/acl/authmethod/read/authmethod_read.go
Authmethod Read module for cli layer
...
<command/acl/authmethod/read/authmethod_read.go> a code:Module ;
    code:name "command/acl/authmethod/read/authmethod_read.go" ;
    code:description "Authmethod Read module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
