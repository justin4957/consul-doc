...
/*
# Module: command/acl/authmethod/create/authmethod_create.go
Authmethod Create module for cli layer
...
<command/acl/authmethod/create/authmethod_create.go> a code:Module ;
    code:name "command/acl/authmethod/create/authmethod_create.go" ;
    code:description "Authmethod Create module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
