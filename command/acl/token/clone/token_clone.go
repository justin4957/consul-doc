...
/*
# Module: command/acl/token/clone/token_clone.go
Token Clone module for cli layer
...
<command/acl/token/clone/token_clone.go> a code:Module ;
    code:name "command/acl/token/clone/token_clone.go" ;
    code:description "Token Clone module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
