...
/*
# Module: command/acl/token/create/token_create.go
Token Create module for cli layer
...
<command/acl/token/create/token_create.go> a code:Module ;
    code:name "command/acl/token/create/token_create.go" ;
    code:description "Token Create module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
