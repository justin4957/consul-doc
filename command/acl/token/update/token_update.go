...
/*
# Module: command/acl/token/update/token_update.go
Token Update module for cli layer
...
<command/acl/token/update/token_update.go> a code:Module ;
    code:name "command/acl/token/update/token_update.go" ;
    code:description "Token Update module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
