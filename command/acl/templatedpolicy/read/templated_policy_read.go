...
/*
# Module: command/acl/templatedpolicy/read/templated_policy_read.go
Templated Policy Read module for cli layer
...
<command/acl/templatedpolicy/read/templated_policy_read.go> a code:Module ;
    code:name "command/acl/templatedpolicy/read/templated_policy_read.go" ;
    code:description "Templated Policy Read module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
