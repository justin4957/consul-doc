...
/*
# Module: command/acl/templatedpolicy/formatter.go
...
<command/acl/templatedpolicy/formatter.go> a code:Module ;
    code:name "command/acl/templatedpolicy/formatter.go" ;
