...
/*
# Module: command/acl/role/create/role_create.go
Role Create module for cli layer
...
<command/acl/role/create/role_create.go> a code:Module ;
    code:name "command/acl/role/create/role_create.go" ;
    code:description "Role Create module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
