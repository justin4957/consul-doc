...
/*
# Module: command/acl/role/update/role_update.go
Role Update module for cli layer
...
<command/acl/role/update/role_update.go> a code:Module ;
    code:name "command/acl/role/update/role_update.go" ;
    code:description "Role Update module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
