...
/*
# Module: command/acl/role/role.go
Role module for cli layer
...
<command/acl/role/role.go> a code:Module ;
    code:name "command/acl/role/role.go" ;
    code:description "Role module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
