...
/*
# Module: command/acl/role/delete/role_delete.go
Role Delete module for cli layer
...
<command/acl/role/delete/role_delete.go> a code:Module ;
    code:name "command/acl/role/delete/role_delete.go" ;
    code:description "Role Delete module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
