...
/*
# Module: command/acl/role/read/role_read.go
Role Read module for cli layer
...
<command/acl/role/read/role_read.go> a code:Module ;
    code:name "command/acl/role/read/role_read.go" ;
    code:description "Role Read module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
