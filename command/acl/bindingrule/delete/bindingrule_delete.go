...
/*
# Module: command/acl/bindingrule/delete/bindingrule_delete.go
Bindingrule Delete module for cli layer
...
<command/acl/bindingrule/delete/bindingrule_delete.go> a code:Module ;
    code:name "command/acl/bindingrule/delete/bindingrule_delete.go" ;
    code:description "Bindingrule Delete module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
