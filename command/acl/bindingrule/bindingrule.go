...
/*
# Module: command/acl/bindingrule/bindingrule.go
Bindingrule module for cli layer
...
<command/acl/bindingrule/bindingrule.go> a code:Module ;
    code:name "command/acl/bindingrule/bindingrule.go" ;
    code:description "Bindingrule module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
