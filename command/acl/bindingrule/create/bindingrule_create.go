...
/*
# Module: command/acl/bindingrule/create/bindingrule_create.go
Bindingrule Create module for cli layer
...
<command/acl/bindingrule/create/bindingrule_create.go> a code:Module ;
    code:name "command/acl/bindingrule/create/bindingrule_create.go" ;
    code:description "Bindingrule Create module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
