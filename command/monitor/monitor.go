...
/*
# Module: command/monitor/monitor.go
Monitor module for cli layer
...
<command/monitor/monitor.go> a code:Module ;
    code:name "command/monitor/monitor.go" ;
    code:description "Monitor module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
