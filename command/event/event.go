...
/*
# Module: command/event/event.go
Event module for cli layer
...
<command/event/event.go> a code:Module ;
    code:name "command/event/event.go" ;
    code:description "Event module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
