...
/*
# Module: command/keygen/keygen.go
Keygen module for cli layer
...
<command/keygen/keygen.go> a code:Module ;
    code:name "command/keygen/keygen.go" ;
    code:description "Keygen module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
