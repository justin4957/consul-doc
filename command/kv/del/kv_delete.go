...
/*
# Module: command/kv/del/kv_delete.go
Kv Delete module for cli layer
...
<command/kv/del/kv_delete.go> a code:Module ;
    code:name "command/kv/del/kv_delete.go" ;
    code:description "Kv Delete module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
