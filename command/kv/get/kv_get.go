...
/*
# Module: command/kv/get/kv_get.go
Kv Get module for cli layer
...
<command/kv/get/kv_get.go> a code:Module ;
    code:name "command/kv/get/kv_get.go" ;
    code:description "Kv Get module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
