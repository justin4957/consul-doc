...
/*
# Module: command/kv/imp/kv_import.go
Kv Import module for cli layer
...
<command/kv/imp/kv_import.go> a code:Module ;
    code:name "command/kv/imp/kv_import.go" ;
    code:description "Kv Import module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
