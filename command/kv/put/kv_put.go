...
/*
# Module: command/kv/put/kv_put.go
Kv Put module for cli layer
...
<command/kv/put/kv_put.go> a code:Module ;
    code:name "command/kv/put/kv_put.go" ;
    code:description "Kv Put module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
