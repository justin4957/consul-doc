...
/*
# Module: command/reload/reload.go
Reload module for cli layer
...
<command/reload/reload.go> a code:Module ;
    code:name "command/reload/reload.go" ;
    code:description "Reload module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
