...
/*
# Module: command/rtt/rtt.go
Rtt module for cli layer
...
<command/rtt/rtt.go> a code:Module ;
    code:name "command/rtt/rtt.go" ;
    code:description "Rtt module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
