...
/*
# Module: command/services/services.go
Services module for cli layer
...
<command/services/services.go> a code:Module ;
    code:name "command/services/services.go" ;
    code:description "Services module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
