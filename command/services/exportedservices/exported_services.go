...
/*
# Module: command/services/exportedservices/exported_services.go
...
<command/services/exportedservices/exported_services.go> a code:Module ;
    code:name "command/services/exportedservices/exported_services.go" ;
