...
/*
# Module: command/join/join.go
Join module for cli layer
...
<command/join/join.go> a code:Module ;
    code:name "command/join/join.go" ;
    code:description "Join module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
