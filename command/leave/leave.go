...
/*
# Module: command/leave/leave.go
Leave module for cli layer
...
<command/leave/leave.go> a code:Module ;
    code:name "command/leave/leave.go" ;
    code:description "Leave module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
