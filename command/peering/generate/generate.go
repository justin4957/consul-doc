...
/*
# Module: command/peering/generate/generate.go
Generate module for cli layer
...
<command/peering/generate/generate.go> a code:Module ;
    code:name "command/peering/generate/generate.go" ;
    code:description "Generate module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
