...
/*
# Module: command/peering/establish/establish.go
Establish module for cli layer
...
<command/peering/establish/establish.go> a code:Module ;
    code:name "command/peering/establish/establish.go" ;
    code:description "Establish module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
