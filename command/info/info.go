...
/*
# Module: command/info/info.go
Info module for cli layer
...
<command/info/info.go> a code:Module ;
    code:name "command/info/info.go" ;
    code:description "Info module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
