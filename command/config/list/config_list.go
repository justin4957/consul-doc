...
/*
# Module: command/config/list/config_list.go
Config List module for cli layer
...
<command/config/list/config_list.go> a code:Module ;
    code:name "command/config/list/config_list.go" ;
    code:description "Config List module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
