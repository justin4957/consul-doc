...
/*
# Module: command/operator/autopilot/set/operator_autopilot_set.go
Operator Autopilot Set module for cli layer
...
<command/operator/autopilot/set/operator_autopilot_set.go> a code:Module ;
    code:name "command/operator/autopilot/set/operator_autopilot_set.go" ;
    code:description "Operator Autopilot Set module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
