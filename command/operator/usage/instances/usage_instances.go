...
/*
# Module: command/operator/usage/instances/usage_instances.go
Usage Instances module for cli layer
...
<command/operator/usage/instances/usage_instances.go> a code:Module ;
    code:name "command/operator/usage/instances/usage_instances.go" ;
    code:description "Usage Instances module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
