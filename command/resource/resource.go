...
/*
# Module: command/resource/resource.go
Resource module for cli layer
...
<command/resource/resource.go> a code:Module ;
    code:name "command/resource/resource.go" ;
    code:description "Resource module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
