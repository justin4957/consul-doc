...
/*
# Module: command/forceleave/forceleave.go
Forceleave module for cli layer
...
<command/forceleave/forceleave.go> a code:Module ;
    code:name "command/forceleave/forceleave.go" ;
    code:description "Forceleave module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
