...
/*
# Module: command/keyring/keyring.go
Keyring module for cli layer
...
<command/keyring/keyring.go> a code:Module ;
    code:name "command/keyring/keyring.go" ;
    code:description "Keyring module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "acl" ;
