...
/*
# Module: command/snapshot/restore/snapshot_restore.go
Snapshot Restore module for cli layer
...
<command/snapshot/restore/snapshot_restore.go> a code:Module ;
    code:name "command/snapshot/restore/snapshot_restore.go" ;
    code:description "Snapshot Restore module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
