...
/*
# Module: command/catalog/list/dc/catalog_list_datacenters.go
Catalog List Datacenters module for cli layer
...
<command/catalog/list/dc/catalog_list_datacenters.go> a code:Module ;
    code:name "command/catalog/list/dc/catalog_list_datacenters.go" ;
    code:description "Catalog List Datacenters module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
