...
/*
# Module: command/maint/maint.go
Maint module for cli layer
...
<command/maint/maint.go> a code:Module ;
    code:name "command/maint/maint.go" ;
    code:description "Maint module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
