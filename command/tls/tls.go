...
/*
# Module: command/tls/tls.go
Tls module for cli layer
...
## Exports
FileDoesNotExist, New

<!-- LinkedDoc RDF -->
@prefix code: <https://schema.codedoc.org/> .
<command/tls/tls.go> a code:Module ;
    code:name "command/tls/tls.go" ;
    code:description "Tls module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
    ...
    code:exports :FileDoesNotExist, :New ;
