...
/*
# Module: command/tls/ca/create/tls_ca_create.go
Tls Ca Create module for cli layer
...
<command/tls/ca/create/tls_ca_create.go> a code:Module ;
    code:name "command/tls/ca/create/tls_ca_create.go" ;
    code:description "Tls Ca Create module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
