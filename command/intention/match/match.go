...
/*
# Module: command/intention/match/match.go
Match module for cli layer
...
<command/intention/match/match.go> a code:Module ;
    code:name "command/intention/match/match.go" ;
    code:description "Match module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
