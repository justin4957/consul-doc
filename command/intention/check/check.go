...
/*
# Module: command/intention/check/check.go
Check module for cli layer
...
## Tags
cli, health-checks, monitoring, user-interface
...
<command/intention/check/check.go> a code:Module ;
    code:name "command/intention/check/check.go" ;
    code:description "Check module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
        code:name "api" ;
    ...
    code:exports :New ;
    code:tags "cli", "health-checks", "monitoring", "user-interface" .
<!-- End LinkedDoc RDF -->
*/
package check
