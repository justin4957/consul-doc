...
/*
# Module: command/intention/list/intention_list.go
Intention List module for cli layer
...
<command/intention/list/intention_list.go> a code:Module ;
    code:name "command/intention/list/intention_list.go" ;
    code:description "Intention List module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
