...
/*
# Module: command/intention/intention.go
Intention module for cli layer
...
<command/intention/intention.go> a code:Module ;
    code:name "command/intention/intention.go" ;
    code:description "Intention module for cli layer" ;
    code:language "go" ;
    code:layer "cli" ;
    code:linksTo [
