...
/*
# Module: logging/names.go
Names module for internal layer
...
<logging/names.go> a code:Module ;
    code:name "logging/names.go" ;
    code:description "Names module for internal layer" ;
    code:language "go" ;
    code:layer "internal" ;
    code:tags "internal" .
<!-- End LinkedDoc RDF -->
